...
public class Resource {
    ...
    @ResponseBody
    @RequestMapping("/reviewtitletip")
    public GPTResponse getReviewTitleTips(@RequestParam("passkey") String passkey, @RequestParam("productid") String productId) throws IOException {
        ...
        return resourceService.getReviewTitleTipsBased(passkey, productId);
